...
abstract class Kohana_Service_Addthis extends Service implements Service_Type_Javascript
{
	...
	public function toolbox_clip($url = NULL, $attributes = NULL, $include = NULL)
	{
		if ( ! $this->initialized())
			return NULL;
		...
		$buttons = array(
			'facebook' => "<a class=\"addthis_button_facebook_like\" fb:like:layout=\"button_count\"></a>",
			'pinterest' => $pin,
	...
	public function body()
	{
		...
		$render = <<<ANALYTICS
  	<script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#pubid={$this->api_key}&async=1"></script>
